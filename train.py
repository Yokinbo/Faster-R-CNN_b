...
# 抑制 transformers 与当前 PyTorch 版本无关的重复环境提示；不影响模型或训练逻辑。
...
if __name__ == "__main__":
    # ------------------------------------------------------------------ #
    # YOLO 数据集根目录。直接读取 train/val 下的 images、labels、classes.txt，
    ...
    #---------------------------------------------------------------------#
    classes_path    = str(validate_yolo_class_files(DATASET_ROOT))
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = str(PRETRAINED_WEIGHT_PATH)
    #------------------------------------------------------#
    ...
    train_lines, train_dataset_summary = build_yolo_annotation_lines(
        DATASET_ROOT, "train", num_classes
    )
    val_lines, val_dataset_summary = build_yolo_annotation_lines(
        DATASET_ROOT, "val", num_classes
    )
    print("YOLO dataset loaded:")
    print(f"  {train_dataset_summary}")
    print(f"  {val_dataset_summary}")
